...
![Codec name: Realtek ALC3254 aka ALC295](../.gitbook/assets/image%20%289%29.png)
...
![Open highlighted file](../.gitbook/assets/image%20%284%29.png)

![Click on Open](../.gitbook/assets/image%20%2810%29.png)

![Open main.m](../.gitbook/assets/image%20%283%29.png)

On line `109` and `120` replace `0x18` and `0x20` with your `Node` and `Pin-ctls` previously found.
