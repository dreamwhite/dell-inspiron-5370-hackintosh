...
After applying the patch look for the first USB 2.0 personality in your list (from the discovering process explained [before](https://dortania.github.io/OpenCore-Post-Install/usb/manual/manual.html#finding-your-usb-ports)).
...
- [@Gengik84](https://github.com/Gengik84) for the original code implementation and the first version of the [guide](https://www.macos86.it/topic/9-mappatura-porte-usb/)
- [@1alessandro1](https://github.com/1alessandro1) for maintaining the guide