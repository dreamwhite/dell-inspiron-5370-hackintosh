...
![Figure 1: codec dump from Clover](../.gitbook/assets/image%20%2810%29.png)

### Step 3: analyze codec dump

![Figure 2: Codec name Realtek ALC3254 aka ALC295](../.gitbook/assets/image%20%2818%29.png)

By scrolling the txt file you'll find something as depicted below

![Figure 3: Node 0x12 Pin Complex](../.gitbook/assets/image%20%2816%29.png)
...
![Figure 4: open highlighted file](../.gitbook/assets/image%20%289%29.png)

![Figure 5: click on Open](../.gitbook/assets/image%20%2819%29.png)

![Figure 6: open main.m](../.gitbook/assets/image%20%287%29.png)
...
![Figure 7: build project](../.gitbook/assets/image%20%2814%29.png)

![Figure 8: project successfully build](../.gitbook/assets/image%20%2812%29.png)

Then expand from left sidebar `Products` folder, right click on `ALCPlugFix` and click on `Show in Finder`.

![Figure 9: XCode Products folder](../.gitbook/assets/image%20%288%29.png)

![Figure 10: Show in finder exec](../.gitbook/assets/image%20%286%29.png)

![Figure 11: ALCPlugFix exec](../.gitbook/assets/image%20%2815%29.png)

Replace `ALCPlugFix` in `alc_fix` folder with the one built before as depicted in `Figure 1` .

![Figure 12: alc\_fix folder](../.gitbook/assets/image%20%2817%29.png)

![Figure 13: replace existing ALCPlugFix](../.gitbook/assets/image%20%283%29.png)

![Figure 14: replaced ALCPlugFix](../.gitbook/assets/image%20%285%29.png)

### Step 5: install the daemon

Open a terminal window and `cd` inside the `ALCPlugFix` folder, and execute `install.sh` 

![Figure 15: daemon installation](../.gitbook/assets/image%20%282%29.png)
